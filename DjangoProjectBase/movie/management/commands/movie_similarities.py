...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Show part of the embeddings
        self.stdout.write("Embedding de La captura (primeros 20 valores):")
        self.stdout.write(str(emb1[:20]))

        self.stdout.write("Embedding de Castillo medieval (primeros 20 valores):")
        self.stdout.write(str(emb2[:20]))
